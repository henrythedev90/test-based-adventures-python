...
class Gandalf(Character):
    def __init__(self, location=None):
        ...
        self.add_dialogue("first_meeting", 
            "As you step outside your comfortable hobbit-hole, the tall figure addresses you: \"Good morning!\" \n\n"
            "When you return the greeting, he looks at you with a twinkle in his eye. \"What do you mean? Do you wish me a good morning, "
            "or mean that it is a good morning whether I want it or not; or that you feel good this morning; "
            "or that it is a morning to be good on?\" \n\n"
            "Before you can properly answer, he continues: \"I am looking for someone to share in an adventure that I am arranging, "
            "and it's very difficult to find anyone.\" \n\n"
            "\"I should think so—in these parts! We are plain quiet folk and have no use for adventures,\" you reply, somewhat flustered. \n\n"
            "The old man's eyes twinkle with amusement. \"I am Gandalf, and Gandalf means me!\""
        )
...
# and thorin_arrival() function already exists to handle Thorin's arrival